...
if [ "$condition" == "red" ]; then
    ...
    --output_dir "Results/RED/Qwen2.5-Math-7B" \
    --data_num 5000 \
    --op_position "ffn_up" \
    --learning_rate 2e-4 \
    ...
    --peft_path "Results/RED/Qwen2.5-Math-7B/5000_prm800k_all_2e-4/ffn_up" \
    ...
    --model_path "Qwen2.5-Math-7B-Instruct" \
    --data_path  "dataset/prm800k/train.json" \
    --output_dir "Results/Test_Weight/Qwen2.5-Math-7B/" \
    --data_num 5000 \
    --n_prefix 64 \
    --op_position "ffn_up" \
    --learning_rate 2e-5 \
    ...
    for n in 1.4 1.7 1.8 1.9 2.0; do
        ...
        --output_dir "Results/Test_Constraint/Qwen3-8B/" \
        --data_num 5000 \
        --n_prefix 64 \
        --op_position "ffn_up" \
        --learning_rate 2e-5 \
    ...
    for n in 1.5; do
        ...
        --model_path "Qwen2.5-Math-7B-Instruct" \
        --data_path  "dataset/math10k/train.json" \
        --output_dir "Results/Test_Constraint/Qwen2.5-Math-7B/" \
        --data_num 5000 \
        --n_prefix 64 \
        --op_position "ffn_up" \
        --learning_rate 2e-4 \
    ...
    --data_path "Results/Base/base/9000_Qwen2.5-Math-7B_all_0_0" \
    --model "qwen" \
    --dataset ${data} \
    --eval_num -1

    python Prefix/eval.py \
    --data_path "Results/Lora/Qwen2.5-Math-7B" \
    --model "qwen" \
    --dataset ${data} \
    --eval_num -1

    python Prefix/eval.py \
    --data_path "Results/RED/Qwen2.5-Math-7B" \
    --model "qwen" \
    --dataset ${data} \
    --eval_num -1

    python Prefix/eval.py \
    --data_path "Results/BREP/Qwen2.5-Math-7B" \
    --model "qwen" \
    --dataset ${data} \
    --eval_num -1
    ...
    --is_train_return False \
    --no_repeat_ngram_size 5 \
    --peft_path "Results/Test_Constraint/Qwen2.5-Math-7B/5000_prm800k_all_64_2e-05_1.2/ffn_up" \
    --repetition_penalty 1.1 \
    --template_index "qwen_math" \
    --data_num -1
    ...
    --model_path "Qwen2.5-Math-7B-Instruct" \
    --output_path "Results/Base/base/9000_Qwen2.5-Math-7B_all_0_0" \
    --dataset "piqa" \
    --data_num -1 \
    --template_index "qwen_math" \
    --vllm False
